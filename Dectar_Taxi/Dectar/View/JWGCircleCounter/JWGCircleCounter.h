...
// Defaults
#define JWG_CIRCLE_COLOR_DEFAULT [UIColor colorWithRed:125/255.0f green:189/255.0f blue:0/255.0f alpha:1]
#define JWG_CIRCLE_BACKGROUND_COLOR_DEFAULT [UIColor colorWithWhite:.85f alpha:1]
#define JWG_CIRCLE_FILL_COLOR_DEFAULT [UIColor whiteColor];
#define JWG_CIRCLE_TIMER_WIDTH 15.0f
