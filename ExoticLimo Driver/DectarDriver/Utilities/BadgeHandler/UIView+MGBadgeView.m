...
@synthesize isTop;
static float const kMGBadgeViewInnerSpaceFromBorder = 13.0;
...
////        } else {
////            position = (topRightInWindow.y < appFrameSize.height) ? MGBadgePositionBottomRight : MGBadgePositionTopLeft;
////        }
//    }
    ...
    switch (position) {
        case MGBadgePositionTopRight: {
            if(IS_IPAD){
                if(isTop==YES){
                    self.center = CGPointMake(superviewFrame.size.width-10, 13);
                }else{
                    self.center = CGPointMake(superviewFrame.size.width-1, 15);
                }
            }else{
                if(isTop==YES){
                    self.center = CGPointMake(superviewFrame.size.width-10, 10);
                }else{
                    self.center = CGPointMake(superviewFrame.size.width+5, 10);
                }
            }
            break;
        }
//        case MGBadgePositionTopLeft: {
//            self.center = CGPointMake(superviewFrame.size.width-10, 20);
//            break;
//        }
